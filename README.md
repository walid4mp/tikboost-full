...
## Deployment note
Render Free deployments apply Prisma migrations during the backend build via
`npm run prisma:migrate:deploy`. Do not use `prisma db push` on production.
The protected primary Super Admin is `admin1@tikboost.app`.
