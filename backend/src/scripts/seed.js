...
const ADMIN_USERS = [
  ...
  { email: 'admin5@tikboost.app', password: ADMIN_PASSWORD, role: 'ADMIN', name: 'Admin 5' },
  { email: 'admin6@tikboost.app', password: ADMIN_PASSWORD, role: 'ADMIN', name: 'Admin 6' },
];
...
const WHEEL = [
  { label: '500', points: 500n, weight: 28, color: '#38bdf8', sortOrder: 0 },
  { label: '1,000', points: 1000n, weight: 22, color: '#22c55e', sortOrder: 1 },
  { label: '2,500', points: 2500n, weight: 15, color: '#a855f7', sortOrder: 2 },
  { label: '5,000', points: 5000n, weight: 10, color: '#f59e0b', sortOrder: 3 },
  { label: '10,000', points: 10000n, weight: 7, color: '#ef4444', sortOrder: 4 },
  { label: '25,000', points: 25000n, weight: 4, color: '#ec4899', sortOrder: 5 },
  { label: '50,000', points: 50000n, weight: 2, color: '#ffd700', sortOrder: 6 },
  { label: '100,000', points: 100000n, weight: 1, color: '#f97316', sortOrder: 7 },
  { label: 'حاول مجددًا', points: 0n, weight: 7, color: '#64748b', sortOrder: 8 },
  { label: 'لم تربح شيئًا', points: 0n, weight: 4, color: '#334155', sortOrder: 9 },
];
...
async function seedCoreData() {
  console.log('▶ Seeding TokAura core data...');
