 ...
 * Accepts an optional Prisma transaction client to participate in an outer transaction.
 */
async function adjustPoints(userId, delta, reason, extra = {}, client = prisma) {
  const run = async (tx) => {
