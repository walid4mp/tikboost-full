...
module.exports = {
  ...
  // Firebase Cloud Messaging (HTTP v1). Set the JSON for a Firebase service account
  // in Render/production; never commit the private key.
  FIREBASE_SERVICE_ACCOUNT_JSON: process.env.FIREBASE_SERVICE_ACCOUNT_JSON || '',
  FIREBASE_PROJECT_ID: process.env.FIREBASE_PROJECT_ID || 'tikboost-df79c',
