...
import 'package:tokaura/config/app_config.dart';
import 'package:tokaura/config/app_theme.dart';

void main() {
  test('app config exposes production defaults', () {
    expect(AppConfig.appName, 'TokAura');
  ...
  testWidgets('light theme renders brand title', (tester) async {
    ...
    expect(find.text('TokAura'), findsOneWidget);
  });
}
