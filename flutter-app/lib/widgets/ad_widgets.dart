...
class _BannerAdCardState extends State<BannerAdCard> {
  ...
  Future<void> _prepare() async {
    ...
    if (AdMobService.instance.customBannerEnabled && AdMobService.instance.customBannerImageUrl.isNotEmpty) {
      AdMobService.instance.recordAdEvent('CUSTOM_BANNER');
      setState(() {});
      return;
    }
    if (!AdMobService.instance.bannerEnabled) return;
  ...
  Widget build(BuildContext context) {
    ...
    if (AdMobService.instance.customBannerEnabled && customUrl.isNotEmpty) {
      ...
      return GestureDetector(
        ...
        child: Container(
          ...
          child: ClipRRect(
            ...
            child: Image.network(customUrl, width: double.infinity, height: 72, fit: BoxFit.cover,
