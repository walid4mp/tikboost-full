          ...
          children: [
                ...
                Expanded(
                  child: Card(
                    child: ListTile(
                      ...
                      onTap: () { SoundService.instance.play('notify.wav'); context.push('/notifications'); },
                    ),
                  ),
                ),
                const SizedBox(width: 10),
                Expanded(
                  child: Card(
                    child: ListTile(
                      ...
                      onTap: () { SoundService.instance.play('notify.wav'); context.push('/contact'); },
                    ),
                  ),
                ),
              ],
            ...
            Card(
              child: ListTile(
                ...
                onTap: () { SoundService.instance.play('notify.wav'); context.push('/referrals'); },
              ),
            ),
