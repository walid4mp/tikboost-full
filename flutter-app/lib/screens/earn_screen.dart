    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          TextButton(onPressed: () async { await SoundService.instance.playTap(); await load(); }, child: const Text('تحديث')),
        ],
      ),
    );
  }
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Row(children: [
                              Expanded(child: Text(_label('${task['type']}'), style: const TextStyle(fontWeight: FontWeight.w800, fontSize: 15))),
                              if (task['vip'] == true) Container(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4), decoration: BoxDecoration(color: Colors.amber.withValues(alpha: .16), borderRadius: BorderRadius.circular(99)), child: const Text('👑 VIP PRO', style: TextStyle(color: Colors.amber, fontSize: 10, fontWeight: FontWeight.w900))),
                            ]),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          OutlinedButton.icon(
                            onPressed: () async { await SoundService.instance.playTap(); await copyComment(task); },
                    ...
                    children: [
                      Expanded(
                        child: ElevatedButton(
                          onPressed: submitting ? null : () async { await SoundService.instance.playTap(); await openTask(task); },
                      ...
                      Expanded(
                        child: OutlinedButton(
                          onPressed: (!opened || submitting)
                              ? null
                              : () async { await SoundService.instance.playTap(); await markExecuted(task); },
