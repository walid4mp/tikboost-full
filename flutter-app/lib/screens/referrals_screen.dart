          ...
          Card(child: Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(children: [
                ...
                IconButton(
                  onPressed: () {
                    SoundService.instance.playTap(); Clipboard.setData(ClipboardData(text: code));
              ...
              if (link.toString().isNotEmpty) ...[
                ...
                Row(children: [
                  ...
                  IconButton(onPressed: () { SoundService.instance.playTap(); Clipboard.setData(ClipboardData(text: link)); ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('تم نسخ رابط الإحالة'))); }, icon: const Icon(Icons.copy, color: AppColors.blue)),
                ]),
              ],
              if (downloadUrl.trim().isNotEmpty) ...[
                ...
                Row(children: [
                  ...
                  IconButton(onPressed: () { SoundService.instance.playTap(); Clipboard.setData(ClipboardData(text: downloadUrl)); ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('تم نسخ رابط تحميل التطبيق'))); }, icon: const Icon(Icons.download, color: AppColors.blue)),
                ]),
              ],
            ]),
          )),
