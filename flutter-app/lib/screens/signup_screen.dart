...
class _SignupScreenState extends ConsumerState<SignupScreen> {
  ...
  Future<void> submit() async {
    ...
    try {
      ...
      setState(() => error = userFriendlyApiError(e, fallback: 'تعذر إنشاء الحساب الآن. حاول مرة أخرى.'));
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              const Text('انضم إلى TokAura اليوم 🎉',
              ...
              const SizedBox(height: 12),
              TextField(controller: password, obscureText: hidePassword,
                decoration: InputDecoration(prefixIcon: const Icon(Icons.lock_outline),
                  hintText: 'كلمة المرور', suffixIcon: IconButton(onPressed: () { SoundService.instance.playTap(); setState(() => hidePassword = !hidePassword); }, icon: Icon(hidePassword ? Icons.visibility_rounded : Icons.visibility_off_rounded)))),
              const SizedBox(height: 12),
              ...
              ElevatedButton(onPressed: busy ? null : () async { await SoundService.instance.playTap(); await submit(); },
              ...
              Center(
                child: TextButton(
                  onPressed: () { SoundService.instance.playTap(); context.go('/login'); },
