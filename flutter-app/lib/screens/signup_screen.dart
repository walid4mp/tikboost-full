            ...
            children: [
              ...
              TextField(controller: password, obscureText: hidePassword,
                decoration: InputDecoration(prefixIcon: const Icon(Icons.lock_outline),
                  hintText: 'كلمة المرور', suffixIcon: IconButton(onPressed: () { SoundService.instance.play('notify.wav'); setState(() => hidePassword = !hidePassword); }, icon: Icon(hidePassword ? Icons.visibility_rounded : Icons.visibility_off_rounded)))),
              const SizedBox(height: 12),
              ...
              Center(
                child: TextButton(
                  onPressed: () { SoundService.instance.play('notify.wav'); context.go('/login'); },
